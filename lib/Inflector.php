 ...
 * Inflector
 *
 * Core Inflector class used to set inflector rules for table mapping and joins
 *
 * PHP versions 5.x
 *
 * Ashok Vishwakarma
 ...
 */
	protected static $_transliteration = array(
		'/Ãƒâ‚¬|Ãƒï¿½|Ãƒâ€š|ÃƒÆ’|Ãƒâ€¦|Ã‡Âº|Ã„â‚¬|Ã„â€š|Ã„â€ž|Ã‡ï¿½/' => 'A',
		'/Ãƒâ€ |Ã‡Â¼/' => 'AE',
		'/Ãƒâ€ž/' => 'Ae',
		'/Ãƒâ€¡|Ã„â€ |Ã„Ë†|Ã„Å |Ã„Å’/' => 'C',
		'/Ãƒï¿½|Ã„Å½|Ã„ï¿½/' => 'D',
		'/ÃƒË†|Ãƒâ€°|ÃƒÅ |Ãƒâ€¹|Ã„â€™|Ã„â€�|Ã„â€“|Ã„Ëœ|Ã„Å¡/' => 'E',
		'/Ã„Å“|Ã„Å¾|Ã„Â |Ã„Â¢|Ã’ï¿½/' => 'G',
		'/Ã„Â¤|Ã„Â¦/' => 'H',
		'/ÃƒÅ’|Ãƒï¿½|ÃƒÅ½|Ãƒï¿½|Ã„Â¨|Ã„Âª|Ã„Â¬|Ã‡ï¿½|Ã„Â®|Ã„Â°|Ã�â€ /' => 'I',
		'/Ã„Â²/' => 'IJ',
		'/Ã„Â´/' => 'J',
		'/Ã„Â¶/' => 'K',
		'/Ã„Â¹|Ã„Â»|Ã„Â½|Ã„Â¿|Ã…ï¿½/' => 'L',
		'/Ãƒâ€˜|Ã…Æ’|Ã…â€¦|Ã…â€¡/' => 'N',
		'/Ãƒâ€™|Ãƒâ€œ|Ãƒâ€�|Ãƒâ€¢|Ã…Å’|Ã…Å½|Ã‡â€˜|Ã…ï¿½|Ã†Â |ÃƒËœ|Ã‡Â¾/' => 'O',
		'/Ã…â€™/' => 'OE',
		'/Ãƒâ€“/' => 'Oe',
		'/Ã…â€�|Ã…â€“|Ã…Ëœ/' => 'R',
		'/Ã…Å¡|Ã…Å“|Ã…Å¾|ÃˆËœ|Ã…Â /' => 'S',
		'/Ã¡ÂºÅ¾/' => 'SS',
		'/Ã…Â¢|ÃˆÅ¡|Ã…Â¤|Ã…Â¦/' => 'T',
		'/ÃƒÅ¾/' => 'TH',
		'/Ãƒâ„¢|ÃƒÅ¡|Ãƒâ€º|Ã…Â¨|Ã…Âª|Ã…Â¬|Ã…Â®|Ã…Â°|Ã…Â²|Ã†Â¯|Ã‡â€œ|Ã‡â€¢|Ã‡â€”|Ã‡â„¢|Ã‡â€º/' => 'U',
		'/ÃƒÅ“/' => 'Ue',
		'/Ã…Â´/' => 'W',
		'/Ãƒï¿½|Ã…Â¸|Ã…Â¶/' => 'Y',
		'/Ã�â€ž/' => 'Ye',
		'/Ã�â€¡/' => 'Yi',
		'/Ã…Â¹|Ã…Â»|Ã…Â½/' => 'Z',
		'/ÃƒÂ |ÃƒÂ¡|ÃƒÂ¢|ÃƒÂ£|ÃƒÂ¥|Ã‡Â»|Ã„ï¿½|Ã„Æ’|Ã„â€¦|Ã‡Å½|Ã‚Âª/' => 'a',
		'/ÃƒÂ¤|ÃƒÂ¦|Ã‡Â½/' => 'ae',
		'/ÃƒÂ§|Ã„â€¡|Ã„â€°|Ã„â€¹|Ã„ï¿½/' => 'c',
		'/ÃƒÂ°|Ã„ï¿½|Ã„â€˜/' => 'd',
		'/ÃƒÂ¨|ÃƒÂ©|ÃƒÂª|ÃƒÂ«|Ã„â€œ|Ã„â€¢|Ã„â€”|Ã„â„¢|Ã„â€º/' => 'e',
		'/Ã†â€™/' => 'f',
		...
		'/Ã„Âµ/' => 'j',
		'/Ã„Â·/' => 'k',
		'/Ã„Âº|Ã„Â¼|Ã„Â¾|Ã…â‚¬|Ã…â€š/' => 'l',
		'/ÃƒÂ±|Ã…â€ž|Ã…â€ |Ã…Ë†|Ã…â€°/' => 'n',
		'/ÃƒÂ²|ÃƒÂ³|ÃƒÂ´|ÃƒÂµ|Ã…ï¿½|Ã…ï¿½|Ã‡â€™|Ã…â€˜|Ã†Â¡|ÃƒÂ¸|Ã‡Â¿|Ã‚Âº/' => 'o',
		'/ÃƒÂ¶|Ã…â€œ/' => 'oe',
		'/Ã…â€¢|Ã…â€”|Ã…â„¢/' => 'r',
		'/Ã…â€º|Ã…ï¿½|Ã…Å¸|Ãˆâ„¢|Ã…Â¡|Ã…Â¿/' => 's',
		'/ÃƒÅ¸/' => 'ss',
		'/Ã…Â£|Ãˆâ€º|Ã…Â¥|Ã…Â§/' => 't',
		'/ÃƒÂ¾/' => 'th',
		'/ÃƒÂ¹|ÃƒÂº|ÃƒÂ»|Ã…Â©|Ã…Â«|Ã…Â­|Ã…Â¯|Ã…Â±|Ã…Â³|Ã†Â°|Ã‡â€�|Ã‡â€“|Ã‡Ëœ|Ã‡Å¡|Ã‡Å“/' => 'u',
		'/ÃƒÂ¼/' => 'ue',
		'/Ã…Âµ/' => 'w',
		'/ÃƒÂ½|ÃƒÂ¿|Ã…Â·/' => 'y',
		'/Ã‘â€�/' => 'ye',
 ...
 * ));
 * Inflector::rules('transliteration', array('/ÃƒÂ¥/' => 'aa'));
 * }}}
 *
